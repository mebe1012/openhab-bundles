...
public class PhilipsTvPairing {
  ...
  public void finishPairingWithTv(PhilipsTvHandler handler) throws NoSuchAlgorithmException, InvalidKeyException, IOException,
          MalformedChallengeException, KeyStoreException, KeyManagementException, AuthenticationException {
